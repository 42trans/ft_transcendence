...
class Consumer(AsyncWebsocketConsumer):
    ...
    async def connect(self, user_id, other_user_id):
    # async def connect(self, model, user_id, other_user_id):
        ...
        await async_log("終了: channel_layer.group_add")
        await self.accept()
    ...
    # @database_sync_to_async
    async def _get_room_group_name(self, model, user_id, other_user_id):
        """
        ...
        try:
            ...
            await async_log(f"作成: room_group_name: {room_group_name}")
