// docker/srcs/uwsgi-django/pong/static/pong/js/online/duel/PongOnlineDuelRenderer.js
/**
 ...
 */
class PongOnlineDuelRenderer 
{
	static render(ctx, field, gameState) 
	{
		PongOnlineDuelRenderer.clearField(ctx, field);
		PongOnlineDuelRenderer.drawPaddle(ctx, gameState.objects.paddle1);
...
export default PongOnlineDuelRenderer;
